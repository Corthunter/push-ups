...
```{r}
boxplot(pushups~position,data=players,main="pushups vs. position")
```

The skill position people does more pushups than the players in the line. 
...
```
This is a summary of the mean and the median; showing the number of pushups done by the whole team.

## Inferential Results
<!--State hypothesis clearly.  Make sure your discussion of the inferential test covers all the aspects that the test output produces, such as test statistic, p-value etc.  Make a decision about the null hypothesis, explain the assumptions on which the selected test/procedure was based, and why the chosen procedure satisfys the assumptions and is appropriate to answer the research question!-->

The test we will use is called the t-test.
...
There is an overal difference between the pushups by positions. This data shows the mean in the Line and the mean in the skills. 
